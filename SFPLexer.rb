...
# Generated at: 2012-03-30 18:07:03
# 
...
module SFP
  ...
  module TokenData
    ...
    define_tokens( :EXPONENT => 10, :T__29 => 29, :T__28 => 28, :T__27 => 27, 
                   ...
                   :ID => 6, :EOF => -1, :T__19 => 19, :BOOLEAN => 9, :ESC_SEQ => 13, 
  ...
  class Lexer < ANTLR3::Lexer
    ...
    RULE_NAMES   = [ "T__17", "T__18", "T__19", "T__20", "T__21", "T__22", 
                     ...
                     "T__47", "T__48", "NULL", "BOOLEAN", "ID", "NUMBER", 
                     "COMMENT", "NL", "WS", "STRING", "EXPONENT", "HEX_DIGIT", 
    ...
    def id!
      ...
      # - - - - main rule block - - - -
      # at line 290:7: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
    ...
    def number!
      ...
      # - - - - main rule block - - - -
      # at line 294:5: ( ( '-' )? ( '0' .. '9' )+ | ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT )
      alt_14 = 4
      ...
      when 2
        # at line 295:9: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
        # at line 295:9: ( '-' )?
        alt_5 = 2
    ...
    def comment!
      ...
      when 2
        # at line 302:9: '/*' ( options {greedy=false; } : . )* '*/'
        match( "/*" )
        # at line 302:14: ( options {greedy=false; } : . )*
    ...
    def string!
      ...
      # - - - - main rule block - - - -
      # at line 314:8: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
      match( 0x22 )
      # at line 314:12: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
    ...
    def esc_seq!
      ...
      # - - - - main rule block - - - -
      # at line 325:5: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      alt_22 = 3
      ...
      when 2
        # at line 326:9: UNICODE_ESC
        unicode_esc!

      when 3
        # at line 327:9: OCTAL_ESC
        octal_esc!
    ...
    def octal_esc!
      ...
      # - - - - main rule block - - - -
      # at line 332:5: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      alt_23 = 3
    ...
    def unicode_esc!
      ...
      # - - - - main rule block - - - -
      # at line 339:9: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
      match( 0x5c )
      match( 0x75 )
      hex_digit!
      hex_digit!
    ...
    def token!
      # at line 1:8: ( T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | NULL | BOOLEAN | ID | NUMBER | COMMENT | NL | WS | STRING )
      alt_24 = 40
      ...
      when 36
        # at line 1:218: NUMBER
        number!

      when 37
        # at line 1:225: COMMENT
        comment!
    ...
    class DFA14 < ANTLR3::DFA
      ...
      def description
        <<-'__dfa_description__'.strip!
          293:1: NUMBER : ( ( '-' )? ( '0' .. '9' )+ | ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT );
        __dfa_description__
      end
    end
    class DFA24 < ANTLR3::DFA
      EOT = unpack( 2, -1, 1, 25, 1, -1, 2, 25, 2, -1, 4, 25, 2, -1, 3, 
                    25, 1, 47, 1, -1, 1, 49, 3, -1, 1, 54, 1, 56, 5, -1, 
                    6, 25, 1, 64, 8, 25, 1, 73, 1, 74, 10, -1, 7, 25, 1, 
                    -1, 6, 25, 1, 88, 1, 25, 2, -1, 2, 25, 1, -1, 5, 25, 
                    1, 97, 1, 98, 1, 99, 2, 25, 1, -1, 1, 102, 1, -1, 1, 
                    99, 2, 25, 1, 105, 2, 25, 3, -1, 2, 25, 1, -1, 2, 25, 
                    1, -1, 1, 25, 1, 113, 4, 25, 1, 118, 1, -1, 4, 25, 1, 
                    -1, 2, 25, 1, 125, 3, 25, 1, -1, 1, 129, 2, 25, 1, -1, 
                    2, 25, 1, 134, 1, 25, 1, -1, 1, 136, 1, -1 )
      EOF = unpack( 137, -1 )
      MIN = unpack( 1, 9, 1, -1, 1, 97, 1, -1, 1, 114, 1, 108, 2, -1, 1, 
                    120, 1, 99, 2, 104, 2, -1, 2, 111, 1, 102, 1, 48, 1, 
                    -1, 1, 61, 1, -1, 1, 46, 1, 42, 2, 61, 5, -1, 3, 108, 
                    1, 109, 1, 97, 1, 116, 1, 45, 1, 116, 2, 101, 1, 117, 
                    1, 101, 1, 115, 1, 116, 1, 108, 2, 45, 10, -1, 1, 101, 
      ...
      MAX = unpack( 1, 125, 1, -1, 1, 105, 1, -1, 1, 114, 1, 111, 2, -1, 
                    ...
                    1, 110, 1, 57, 1, -1, 1, 61, 1, -1, 4, 61, 5, -1, 3, 
                    108, 1, 110, 1, 97, 1, 116, 1, 122, 1, 116, 2, 101, 
                    1, 117, 1, 101, 1, 115, 1, 116, 1, 108, 2, 122, 10, 
                    -1, 1, 101, 1, 115, 1, 40, 1, 112, 2, 115, 1, 101, 1, 
                    -1, 1, 105, 2, 110, 1, 101, 1, 99, 1, 116, 1, 122, 1, 
                    108, 2, -1, 1, 40, 1, 101, 1, -1, 1, 111, 1, 116, 1, 
                    115, 1, 110, 1, 111, 3, 122, 1, 111, 1, 99, 1, -1, 1, 
                    122, 1, -1, 1, 122, 1, 115, 1, 114, 1, 122, 1, 100, 
      ...
      ACCEPT = unpack( 1, -1, 1, 1, 1, -1, 1, 3, 2, -1, 1, 6, 1, 7, 4, -1, 
                       1, 14, 1, 15, 4, -1, 1, 23, 1, -1, 1, 25, 4, -1, 
                       1, 35, 1, 36, 1, 38, 1, 39, 1, 40, 17, -1, 1, 22, 
                       1, 27, 1, 24, 1, 26, 1, 28, 1, 37, 1, 30, 1, 29, 
                       1, 32, 1, 31, 7, -1, 1, 10, 8, -1, 1, 20, 1, 21, 
                       2, -1, 1, 4, 10, -1, 1, 19, 1, -1, 1, 2, 6, -1, 1, 
                       11, 1, 12, 1, 34, 2, -1, 1, 33, 2, -1, 1, 8, 7, -1, 
                       1, 13, 4, -1, 1, 9, 6, -1, 1, 5, 3, -1, 1, 18, 4, 
                       -1, 1, 16, 1, -1, 1, 17 )
      SPECIAL = unpack( 137, -1 )
      TRANSITION = [
        unpack( 1, 28, 1, 27, 2, -1, 1, 27, 18, -1, 1, 28, 1, -1, 1, 29, 
                1, 1, 1, 18, 3, -1, 1, 12, 1, 3, 1, 19, 1, 20, 1, 13, 1, 
                21, 1, 17, 1, 22, 10, 26, 2, -1, 1, 24, 1, -1, 1, 23, 2, 
        ...
        unpack( 1, 48 ),
        unpack(  ),
        unpack( 1, 26, 1, -1, 10, 26, 3, -1, 1, 50 ),
        unpack( 1, 52, 4, -1, 1, 52, 13, -1, 1, 51 ),
        unpack( 1, 53 ),
        unpack( 1, 55 ),
        unpack(  ),
        unpack(  ),
      ...
      def description
        <<-'__dfa_description__'.strip!
          1:1: Tokens : ( T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | NULL | BOOLEAN | ID | NUMBER | COMMENT | NL | WS | STRING );
        __dfa_description__
      end
    end
