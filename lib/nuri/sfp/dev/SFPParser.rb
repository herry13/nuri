...
# Generated at: 2013-01-02 02:39:07
# 
...
module SFP
  ...
  class Parser < ANTLR3::Parser
    ...
    # 
    # (in SFP.g)
    # 676:1: conditional_constraint_then_part : ( 'then' constraint_statement | 'then' '{' ( NL )+ constraint_body '}' );
    # 
    def conditional_constraint_then_part
      ...
      begin
        # at line 677:2: ( 'then' constraint_statement | 'then' '{' ( NL )+ constraint_body '}' )
        alt_125 = 2
        ...
        when 1
          ...
          # at line 677:4: 'then' constraint_statement
        ...
        when 2
          ...
          # at line 686:4: 'then' '{' ( NL )+ constraint_body '}'
    ...
    # 
    # (in SFP.g)
    # 699:1: mutation_body : ( ( mutation_statement | mutation_iterator ) ( NL )+ )* ;
    # 
    def mutation_body
      # -> uncomment the next line to manually enable rule tracing
      ...
      begin
        ...
        # at line 700:4: ( ( mutation_statement | mutation_iterator ) ( NL )+ )*
        # at line 700:4: ( ( mutation_statement | mutation_iterator ) ( NL )+ )*
        while true # decision 128
          ...
          when 1
            ...
            # at line 701:4: ( mutation_statement | mutation_iterator )
            alt_126 = 2
            ...
            case alt_126
            when 1
              # at line 701:6: mutation_statement
            ...
            when 2
              # at line 703:6: mutation_iterator
    ...
    # 
    # (in SFP.g)
    # 708:1: mutation_iterator : 'foreach' path 'as' ID ( NL )* '{' ( NL )+ ( mutation_statement ( NL )+ )* '}' ;
    # 
    def mutation_iterator
      ...
      begin
        ...
        # at line 709:4: 'foreach' path 'as' ID ( NL )* '{' ( NL )+ ( mutation_statement ( NL )+ )* '}'
        ...
        # <-- action
        # at line 719:3: ( mutation_statement ( NL )+ )*
        while true # decision 132
          ...
          case alt_132
          when 1
            # at line 719:4: mutation_statement ( NL )+
    ...
    # 
    # (in SFP.g)
    # 726:1: mutation_statement returns [key, val] : ( reference equals_op value | reference equals_op NULL | reference binary_op NUMBER | reference 'is' 'new' path ( object_body )? | 'delete' path | reference 'add(' value ')' | reference 'remove(' value ')' );
    # 
    def mutation_statement
      ...
      begin
        # at line 727:2: ( reference equals_op value | reference equals_op NULL | reference binary_op NUMBER | reference 'is' 'new' path ( object_body )? | 'delete' path | reference 'add(' value ')' | reference 'remove(' value ')' )
        alt_134 = 7
        ...
        when 1
          ...
          # at line 727:4: reference equals_op value
        ...
        when 2
          ...
          # at line 735:4: reference equals_op NULL
        ...
        when 3
          ...
          # at line 743:4: reference binary_op NUMBER
        ...
        when 4
          ...
          # at line 751:4: reference 'is' 'new' path ( object_body )?
        ...
        when 6
          ...
          # at line 777:4: reference 'add(' value ')'
        ...
        when 7
          ...
          # at line 785:4: reference 'remove(' value ')'
    ...
    # 
    # (in SFP.g)
    # 795:1: set_value returns [val] : '(' ( set_item ( ',' set_item )* )? ')' ;
    # 
    def set_value
      # -> uncomment the next line to manually enable rule tracing
      ...
      begin
        ...
        # at line 796:4: '(' ( set_item ( ',' set_item )* )? ')'
        ...
        # --> action
        	@set = Array.new	
        # <-- action
        # at line 798:3: ( set_item ( ',' set_item )* )?
        alt_136 = 2
        look_136_0 = @input.peek( 1 )

        if ( look_136_0.between?( STRING, NUMBER ) || look_136_0.between?( BOOLEAN, MULTILINE_STRING ) || look_136_0 == T__36 )
          alt_136 = 1
        end
        case alt_136
        when 1
          # at line 798:4: set_item ( ',' set_item )*
          ...
          while true # decision 135
            ...
            when 1
              ...
              @state.following.push( TOKENS_FOLLOWING_set_item_IN_set_value_2237 )
              set_item380 = set_item
              @state.following.pop
              @adaptor.add_child( root_0, set_item380.tree )
        ...
        # <-- action
        char_literal381 = match( T__38, TOKENS_FOLLOWING_T__38_IN_set_value_2249 )
    ...
    def set_item
      ...
      begin
        ...
        # at line 804:4: value
        @state.following.push( TOKENS_FOLLOWING_value_IN_set_item_2260 )
        value382 = value
        @state.following.pop
        @adaptor.add_child( root_0, value382.tree )
        # --> action
        	@set.push(( value382.nil? ? nil : value382.val ))	
        # <-- action
        # - - - - - - - rule clean up - - - - - - - -
        return_value.stop = @input.look( -1 )
    ...
    # 
    # (in SFP.g)
    # 808:1: value returns [val, type] : ( primitive_value | reference | set_value );
    # 
    def value
      # -> uncomment the next line to manually enable rule tracing
      ...
      root_0 = nil
      primitive_value383 = nil
      reference384 = nil
      set_value385 = nil


      begin
        # at line 809:2: ( primitive_value | reference | set_value )
        alt_137 = 3
        ...
        when 1
          ...
          # at line 809:4: primitive_value
          @state.following.push( TOKENS_FOLLOWING_primitive_value_IN_value_2279 )
          primitive_value383 = primitive_value
          @state.following.pop
          @adaptor.add_child( root_0, primitive_value383.tree )
          # --> action

          			return_value.val = ( primitive_value383.nil? ? nil : primitive_value383.val )
          			return_value.type = ( primitive_value383.nil? ? nil : primitive_value383.type )
        ...
        when 2
          ...
          # at line 814:4: reference
          @state.following.push( TOKENS_FOLLOWING_reference_IN_value_2288 )
          reference384 = reference
          @state.following.pop
          @adaptor.add_child( root_0, reference384.tree )
          # --> action

          			return_value.val = ( reference384.nil? ? nil : reference384.val )
        ...
        when 3
          ...
          # at line 819:4: set_value
          @state.following.push( TOKENS_FOLLOWING_set_value_IN_value_2297 )
          set_value385 = set_value
          @state.following.pop
          @adaptor.add_child( root_0, set_value385.tree )
          # --> action

          			return_value.val = ( set_value385.nil? ? nil : set_value385.val )
    ...
    # 
    # (in SFP.g)
    # 826:1: primitive_value returns [val, type] : ( BOOLEAN | NUMBER | STRING | MULTILINE_STRING );
    # 
    def primitive_value
      # -> uncomment the next line to manually enable rule tracing
      ...
      __NUMBER387__ = nil
      __STRING388__ = nil
      __MULTILINE_STRING389__ = nil

      tree_for_BOOLEAN386 = nil
      tree_for_NUMBER387 = nil
      tree_for_STRING388 = nil
      tree_for_MULTILINE_STRING389 = nil

      begin
        # at line 827:2: ( BOOLEAN | NUMBER | STRING | MULTILINE_STRING )
        alt_138 = 4
        ...
        when 1
          ...
          # at line 827:4: BOOLEAN
          __BOOLEAN386__ = match( BOOLEAN, TOKENS_FOLLOWING_BOOLEAN_IN_primitive_value_2316 )

          tree_for_BOOLEAN386 = @adaptor.create_with_payload( __BOOLEAN386__ )
          @adaptor.add_child( root_0, tree_for_BOOLEAN386 )

          # --> action

          			if __BOOLEAN386__.text == 'true' or __BOOLEAN386__.text == 'on' or __BOOLEAN386__.text == 'yes'
        ...
        when 2
          ...
          # at line 836:4: NUMBER
          __NUMBER387__ = match( NUMBER, TOKENS_FOLLOWING_NUMBER_IN_primitive_value_2325 )
          ...
          # --> action
          			...
          			return_value.val = __NUMBER387__.text.to_i
        ...
        when 3
          ...
          # at line 841:4: STRING
          __STRING388__ = match( STRING, TOKENS_FOLLOWING_STRING_IN_primitive_value_2334 )

          tree_for_STRING388 = @adaptor.create_with_payload( __STRING388__ )
          @adaptor.add_child( root_0, tree_for_STRING388 )

          # --> action

          			return_value.val = __STRING388__.text[1,__STRING388__.text.length-2]
        ...
        when 4
          ...
          # at line 846:4: MULTILINE_STRING
          __MULTILINE_STRING389__ = match( MULTILINE_STRING, TOKENS_FOLLOWING_MULTILINE_STRING_IN_primitive_value_2343 )

          tree_for_MULTILINE_STRING389 = @adaptor.create_with_payload( __MULTILINE_STRING389__ )
          @adaptor.add_child( root_0, tree_for_MULTILINE_STRING389 )

          # --> action

          			return_value.val = __MULTILINE_STRING389__.text[2, __MULTILINE_STRING389__.text.length-2]
          			return_value.type = 'String'
    ...
    def path
      ...
      begin
        ...
        # at line 854:4: ID ( '.' ID )*
        __ID390__ = match( ID, TOKENS_FOLLOWING_ID_IN_path_2358 )

        tree_for_ID390 = @adaptor.create_with_payload( __ID390__ )
        @adaptor.add_child( root_0, tree_for_ID390 )
    ...
    # 
    # (in SFP.g)
    # 857:1: path_with_index : id_ref ( '.' id_ref )* ;
    # 
    def path_with_index
      # -> uncomment the next line to manually enable rule tracing
      ...
      tree_for_char_literal394 = nil

      begin
        root_0 = @adaptor.create_flat_list


        # at line 858:4: id_ref ( '.' id_ref )*
        @state.following.push( TOKENS_FOLLOWING_id_ref_IN_path_with_index_2374 )
        id_ref393 = id_ref
        @state.following.pop
        @adaptor.add_child( root_0, id_ref393.tree )
        # at line 858:10: ( '.' id_ref )*
        while true # decision 140
          ...
          case alt_140
          when 1
            # at line 858:11: '.' id_ref
            char_literal394 = match( T__64, TOKENS_FOLLOWING_T__64_IN_path_with_index_2376 )
    ...
    def id_ref
      ...
      begin
        ...
        # at line 862:4: ID ( '[' NUMBER ']' )?
        __ID396__ = match( ID, TOKENS_FOLLOWING_ID_IN_id_ref_2390 )

        tree_for_ID396 = @adaptor.create_with_payload( __ID396__ )
        @adaptor.add_child( root_0, tree_for_ID396 )

        # at line 862:6: ( '[' NUMBER ']' )?
        alt_141 = 2
        ...
        case alt_141
        when 1
          # at line 862:7: '[' NUMBER ']'
          char_literal397 = match( T__26, TOKENS_FOLLOWING_T__26_IN_id_ref_2392 )

          tree_for_char_literal397 = @adaptor.create_with_payload( char_literal397 )
          @adaptor.add_child( root_0, tree_for_char_literal397 )

          __NUMBER398__ = match( NUMBER, TOKENS_FOLLOWING_NUMBER_IN_id_ref_2394 )

          tree_for_NUMBER398 = @adaptor.create_with_payload( __NUMBER398__ )
          @adaptor.add_child( root_0, tree_for_NUMBER398 )

          char_literal399 = match( T__27, TOKENS_FOLLOWING_T__27_IN_id_ref_2396 )
    ...
    # 
    # (in SFP.g)
    # 865:1: reference returns [val] : path_with_index ;
    # 
    def reference
      # -> uncomment the next line to manually enable rule tracing
      ...
      begin
        ...
        # at line 866:4: path_with_index
        @state.following.push( TOKENS_FOLLOWING_path_with_index_IN_reference_2413 )
        path_with_index400 = path_with_index
        @state.following.pop
        @adaptor.add_child( root_0, path_with_index400.tree )
        # --> action
        	return_value.val = self.to_ref(( path_with_index400 && @input.to_s( path_with_index400.start, path_with_index400.stop ) ))	
        # <-- action
        # - - - - - - - rule clean up - - - - - - - -
        return_value.stop = @input.look( -1 )
    ...
    # 
    # (in SFP.g)
    # 870:1: reference_type returns [val] : 'isref' path ;
    # 
    def reference_type
      # -> uncomment the next line to manually enable rule tracing
      ...
      begin
        ...
        # at line 871:4: 'isref' path
        string_literal401 = match( T__65, TOKENS_FOLLOWING_T__65_IN_reference_type_2432 )
        ...
        @state.following.push( TOKENS_FOLLOWING_path_IN_reference_type_2434 )
        path402 = path
        @state.following.pop
        @adaptor.add_child( root_0, path402.tree )
        # --> action

        			return_value.val = { '_context' => 'null',
        				'_isa' => self.to_ref(( path402 && @input.to_s( path402.start, path402.stop ) ))
        			}
    ...
    # 
    # (in SFP.g)
    # 879:1: set_type returns [val] : 'isset' path ;
    # 
    def set_type
      # -> uncomment the next line to manually enable rule tracing
      ...
      begin
        ...
        # at line 880:4: 'isset' path
        string_literal403 = match( T__40, TOKENS_FOLLOWING_T__40_IN_set_type_2453 )
        ...
        @state.following.push( TOKENS_FOLLOWING_path_IN_set_type_2455 )
        path404 = path
        @state.following.pop
    ...
    TOKENS_FOLLOWING_T__37_IN_set_value_2235 = Set[ 5, 6, 7, 9, 10, 36 ]
    TOKENS_FOLLOWING_set_item_IN_set_value_2237 = Set[ 37, 38 ]
    TOKENS_FOLLOWING_T__38_IN_set_value_2249 = Set[ 1 ]
    TOKENS_FOLLOWING_value_IN_set_item_2260 = Set[ 1 ]
    TOKENS_FOLLOWING_primitive_value_IN_value_2279 = Set[ 1 ]
    TOKENS_FOLLOWING_reference_IN_value_2288 = Set[ 1 ]
    TOKENS_FOLLOWING_set_value_IN_value_2297 = Set[ 1 ]
    TOKENS_FOLLOWING_BOOLEAN_IN_primitive_value_2316 = Set[ 1 ]
    TOKENS_FOLLOWING_NUMBER_IN_primitive_value_2325 = Set[ 1 ]
    TOKENS_FOLLOWING_STRING_IN_primitive_value_2334 = Set[ 1 ]
    TOKENS_FOLLOWING_MULTILINE_STRING_IN_primitive_value_2343 = Set[ 1 ]
    TOKENS_FOLLOWING_ID_IN_path_2358 = Set[ 1, 64 ]
    TOKENS_FOLLOWING_T__64_IN_path_2360 = Set[ 6 ]
    TOKENS_FOLLOWING_ID_IN_path_2361 = Set[ 1, 64 ]
    TOKENS_FOLLOWING_id_ref_IN_path_with_index_2374 = Set[ 1, 64 ]
    TOKENS_FOLLOWING_T__64_IN_path_with_index_2376 = Set[ 6 ]
    TOKENS_FOLLOWING_id_ref_IN_path_with_index_2377 = Set[ 1, 64 ]
    TOKENS_FOLLOWING_ID_IN_id_ref_2390 = Set[ 1, 26 ]
    TOKENS_FOLLOWING_T__26_IN_id_ref_2392 = Set[ 7 ]
    TOKENS_FOLLOWING_NUMBER_IN_id_ref_2394 = Set[ 27 ]
    TOKENS_FOLLOWING_T__27_IN_id_ref_2396 = Set[ 1 ]
    TOKENS_FOLLOWING_path_with_index_IN_reference_2413 = Set[ 1 ]
    TOKENS_FOLLOWING_T__65_IN_reference_type_2432 = Set[ 6 ]
    TOKENS_FOLLOWING_path_IN_reference_type_2434 = Set[ 1 ]
    TOKENS_FOLLOWING_T__40_IN_set_type_2453 = Set[ 6 ]
    TOKENS_FOLLOWING_path_IN_set_type_2455 = Set[ 1 ]
