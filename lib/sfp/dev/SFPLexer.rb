...
# Generated at: 2012-07-31 11:11:50
# 
...
module SFP
  ...
  class Lexer < ANTLR3::Lexer
    ...
    def boolean!
      ...
      # - - - - main rule block - - - -
      # at line 611:2: ( 'true' | 'false' | 'yes' | 'no' )
      alt_1 = 4
      case look_1 = @input.peek( 1 )
      when 0x74 then alt_1 = 1
      when 0x66 then alt_1 = 2
      when 0x79 then alt_1 = 3
      when 0x6e then alt_1 = 4
      else
    ...
    def id!
      ...
      # - - - - main rule block - - - -
      # at line 617:6: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
    ...
    def number!
      ...
      # - - - - main rule block - - - -
      # at line 621:2: ( ( '-' )? ( '0' .. '9' )+ | ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT )
      alt_14 = 4
      ...
      when 2
        # at line 622:4: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
        # at line 622:4: ( '-' )?
        alt_5 = 2
    ...
    def comment!
      ...
      when 2
        # at line 629:6: '/*' ( options {greedy=false; } : . )* '*/'
        match( "/*" )
        # at line 629:11: ( options {greedy=false; } : . )*
    ...
    def multiline_string!
      ...
      # - - - - main rule block - - - -
      # at line 633:4: 'r\"' ( options {greedy=false; } : . )* '\"'
      match( "r\"" )
      # at line 633:9: ( options {greedy=false; } : . )*
    ...
    def string!
      ...
      # - - - - main rule block - - - -
      # at line 643:5: '\"' ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )* '\"'
      match( 0x22 )
      # at line 643:9: ( ESC_SEQ | ~ ( '\\\\' | '\"' ) )*
    ...
    def esc_seq!
      ...
      # - - - - main rule block - - - -
      # at line 654:2: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | UNICODE_ESC | OCTAL_ESC )
      alt_23 = 3
      ...
      when 2
        # at line 655:6: UNICODE_ESC
        unicode_esc!

      when 3
        # at line 656:6: OCTAL_ESC
        octal_esc!
    ...
    def octal_esc!
      ...
      # - - - - main rule block - - - -
      # at line 661:2: ( '\\\\' ( '0' .. '3' ) ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) ( '0' .. '7' ) | '\\\\' ( '0' .. '7' ) )
      alt_24 = 3
    ...
    def unicode_esc!
      ...
      # - - - - main rule block - - - -
      # at line 668:6: '\\\\' 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT
      match( 0x5c )
      match( 0x75 )
      hex_digit!
      hex_digit!
    ...
    class DFA14 < ANTLR3::DFA
      ...
      def description
        <<-'__dfa_description__'.strip!
          620:1: NUMBER : ( ( '-' )? ( '0' .. '9' )+ | ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT );
        __dfa_description__
      end
    end
    class DFA25 < ANTLR3::DFA
      EOT = unpack( 1, -1, 2, 28, 2, -1, 5, 28, 3, -1, 5, 28, 1, 57, 6, 
                    -1, 1, 62, 1, 64, 1, 28, 5, -1, 1, 67, 1, 71, 1, 72, 
                    7, 28, 1, 82, 3, 28, 1, 86, 3, 28, 1, 91, 4, 28, 9, 
                    -1, 2, 28, 1, -1, 1, 98, 2, 28, 2, -1, 9, 28, 1, -1, 
                    3, 28, 1, -1, 3, 28, 1, 117, 1, -1, 1, 118, 3, 28, 1, 
                    91, 1, 28, 1, -1, 1, 123, 3, 28, 1, 127, 5, 28, 1, 133, 
                    1, 91, 3, 28, 1, -1, 2, 28, 2, -1, 1, 139, 3, 28, 1, 
                    -1, 1, 143, 1, 144, 1, 28, 1, -1, 2, 28, 1, 148, 2, 
                    28, 1, -1, 4, 28, 1, 91, 1, -1, 3, 28, 2, -1, 3, 28, 
                    1, -1, 4, 28, 1, 165, 1, 28, 1, 167, 1, 28, 1, 169, 
                    3, 28, 1, 173, 1, 174, 2, 28, 1, -1, 1, 177, 3, -1, 
                    3, 28, 2, -1, 1, 181, 1, 28, 1, -1, 1, 183, 2, 28, 1, 
                    -1, 1, 186, 1, -1, 1, 187, 1, 188, 3, -1 )
      EOF = unpack( 189, -1 )
      MIN = unpack( 1, 9, 1, 102, 1, 116, 2, -1, 1, 108, 1, 102, 1, 104, 
                    1, 112, 1, 114, 3, -1, 1, 100, 1, 97, 2, 101, 1, 34, 
                    1, 48, 3, -1, 1, 46, 1, -1, 1, 42, 2, 61, 1, 101, 5, 
                    -1, 3, 45, 1, 97, 1, 109, 1, 97, 1, 116, 1, 102, 1, 
                    101, 1, 117, 1, 45, 1, 101, 1, 111, 1, 101, 1, 45, 1, 
                    100, 1, 114, 1, 108, 1, 45, 1, 119, 2, 108, 1, 109, 
                    9, -1, 1, 115, 1, 108, 1, -1, 1, 45, 1, 116, 1, 101, 
                    2, -1, 1, 116, 1, 112, 1, 116, 1, 100, 1, 115, 2, 101, 
                    1, 110, 1, 101, 1, -1, 1, 114, 1, 99, 1, 97, 1, -1, 
                    1, 40, 1, 101, 1, 115, 1, 45, 1, -1, 1, 45, 1, 108, 
                    1, 101, 1, 111, 1, 45, 1, 117, 1, -1, 1, 45, 1, 102, 
                    1, 101, 1, 111, 1, 45, 1, 105, 1, 116, 1, 115, 1, 110, 
                    1, 99, 2, 45, 1, 97, 1, 101, 1, 108, 1, -1, 1, 97, 1, 
                    101, 2, -1, 1, 45, 1, 116, 1, 118, 1, 100, 1, -1, 2, 
                    45, 1, 115, 1, -1, 1, 116, 1, 114, 1, 45, 1, 100, 1, 
                    116, 1, -1, 1, 116, 1, 100, 1, 108, 1, 99, 1, 45, 1, 
                    -1, 3, 101, 2, -1, 2, 105, 1, 97, 1, -1, 2, 115, 1, 
                    111, 1, 117, 1, 45, 1, 104, 1, 45, 1, 40, 1, 45, 1, 
                    116, 1, 111, 1, 105, 2, 45, 2, 114, 1, -1, 1, 45, 3, 
                    -1, 1, 101, 2, 110, 2, -1, 1, 45, 1, 101, 1, -1, 1, 
                    45, 1, 115, 1, 116, 1, -1, 1, 45, 1, -1, 2, 45, 3, -1 )
      MAX = unpack( 1, 125, 1, 115, 1, 116, 2, -1, 1, 111, 1, 120, 3, 114, 
                    ...
                    1, 101, 1, 111, 1, 101, 1, 122, 1, 100, 1, 114, 1, 108, 
                    1, 122, 1, 119, 2, 108, 1, 109, 9, -1, 1, 115, 1, 108, 
                    1, -1, 1, 122, 1, 116, 1, 101, 2, -1, 1, 116, 1, 112, 
                    1, 116, 2, 115, 2, 101, 1, 110, 1, 101, 1, -1, 1, 114, 
                    1, 99, 1, 97, 1, -1, 1, 40, 1, 101, 1, 115, 1, 122, 
                    1, -1, 1, 122, 1, 108, 1, 101, 1, 111, 1, 122, 1, 117, 
                    1, -1, 1, 122, 1, 102, 1, 101, 1, 111, 1, 122, 1, 105, 
                    1, 116, 1, 115, 1, 110, 1, 99, 2, 122, 1, 97, 1, 101, 
                    1, 108, 1, -1, 1, 97, 1, 101, 2, -1, 1, 122, 1, 116, 
                    1, 118, 1, 100, 1, -1, 2, 122, 1, 115, 1, -1, 1, 116, 
                    1, 114, 1, 122, 1, 100, 1, 116, 1, -1, 1, 116, 1, 100, 
                    1, 108, 1, 99, 1, 122, 1, -1, 3, 101, 2, -1, 2, 105, 
                    1, 97, 1, -1, 2, 115, 1, 111, 1, 117, 1, 122, 1, 104, 
                    1, 122, 1, 40, 1, 122, 1, 116, 1, 111, 1, 105, 2, 122, 
                    2, 114, 1, -1, 1, 122, 3, -1, 1, 101, 2, 110, 2, -1, 
                    1, 122, 1, 101, 1, -1, 1, 122, 1, 115, 1, 116, 1, -1, 
                    1, 122, 1, -1, 2, 122, 3, -1 )
      ACCEPT = unpack( 3, -1, 1, 3, 1, 4, 5, -1, 1, 17, 1, 18, 1, 19, 6, 
                       -1, 1, 34, 1, 35, 1, 36, 1, -1, 1, 38, 4, -1, 1, 
                       46, 1, 47, 1, 50, 1, 51, 1, 52, 23, -1, 1, 49, 1, 
                       32, 1, 37, 1, 39, 1, 48, 1, 41, 1, 40, 1, 43, 1, 
                       42, 2, -1, 1, 25, 3, -1, 1, 24, 1, 9, 9, -1, 1, 11, 
                       3, -1, 1, 23, 4, -1, 1, 45, 6, -1, 1, 8, 15, -1, 
      ...
      TRANSITION = [
        ...
        unpack( 1, 44, 1, -1, 1, 43 ),
        unpack( 1, 45 ),
        unpack(  ),
        unpack(  ),
        unpack(  ),
        unpack( 1, 48, 13, -1, 1, 46, 1, 47 ),
        unpack( 1, 50, 13, -1, 1, 49 ),
        unpack( 1, 52, 9, -1, 1, 51, 5, -1, 1, 53 ),
        unpack( 1, 54 ),
        unpack( 1, 56, 66, -1, 1, 55 ),
        unpack( 10, 29 ),
        unpack(  ),
        unpack(  ),
        unpack(  ),
        unpack( 1, 29, 1, -1, 10, 29, 3, -1, 1, 58 ),
        unpack(  ),
        unpack( 1, 60, 4, -1, 1, 60, 13, -1, 1, 59 ),
        unpack( 1, 61 ),
        unpack( 1, 63 ),
        unpack( 1, 65 ),
        unpack(  ),
        ...
        unpack( 1, 28, 2, -1, 10, 28, 7, -1, 26, 28, 4, -1, 1, 28, 1, -1, 
                 2, 28, 1, 66, 23, 28 ),
        unpack( 1, 28, 2, -1, 10, 28, 7, -1, 26, 28, 4, -1, 1, 28, 1, -1, 
                 1, 68, 12, 28, 1, 69, 3, 28, 1, 70, 8, 28 ),
        unpack( 1, 28, 2, -1, 10, 28, 7, -1, 26, 28, 4, -1, 1, 28, 1, -1, 
                 26, 28 ),
        unpack( 1, 73 ),
        unpack( 1, 74, 1, 76, 4, -1, 1, 75 ),
        unpack( 1, 77 ),
        unpack( 1, 78 ),
        unpack( 1, 79 ),
        unpack( 1, 80 ),
